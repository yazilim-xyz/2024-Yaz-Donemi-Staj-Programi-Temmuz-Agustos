            ...
            return (
              <div key={product.id} className="flex items-center p-4 bg-white border border-gray-300 rounded-lg shadow-md transform transition-transform duration-300 ease-in-out hover:scale-105">
                ...
                <div className="w-1/2 px-4">
                  ...
                  <p className="text-black">Stok: <span className="text-gray-600">{product.quantity}</span></p>
                </div>
                <div className="w-1/4 text-right">
                  ...
                  <div className="mt-2 flex justify-end space-x-4">
                    <button
                      ...
                      className="text-blue-500 hover:text-blue-700 transform transition-transform duration-300 ease-in-out hover:scale-105"
                    >
