      ...
      <div className="flex items-center space-x-4 transition-all duration-300 ease-in-out">
        ...
        <div className="flex items-center space-x-4">
          <div className="relative group flex items-center space-x-2 transition-all duration-300 ease-in-out">
            <p className="font-semibold hidden md:block">{user.displayName}</p> {/* Profil adını sadece orta ve büyük ekranlarda göster */}
            <img
              src={person}
              alt="User Icon"
        ...
        <button onClick={toggleCartVisibility} className="w-16 h-16 rounded-full bg-transparent flex items-center justify-center overflow-hidden z-50 lg:hidden">
