    ...
    <div className="relative h-screen bg-cover bg-center" style={{ backgroundImage: 'url(https://i.pinimg.com/originals/ef/37/81/ef37815019ae52354c7c5772f4e886d6.png)' }}>
      <div className="flex items-center justify-center h-full">
        <div className="w-4/5 h-4/5 bg-secondary bg-opacity-50 text-white shadow-lg rounded-lg flex">
          <div className="w-1/2 p-8 flex flex-col items-center justify-between bg-primary bg-opacity-80 text-primary relative">
            <div className="flex flex-col items-center justify-center flex-grow">
              <img
                src={logo}
                alt="WorkChat Logo"
                className="h-72 w-72  rounded-full border-4 border-black shadow-lg transition-transform transform hover:scale-105"
                style={{ opacity: 0.9, transform: 'translateY(-3rem)' }} // Yukarı taşıma ve saydamlık
              />
              <p className="text-lg mb-8 text-center text-white">İş yerinizde kolay ve hızlı iletişim kurun.</p>
            </div>
